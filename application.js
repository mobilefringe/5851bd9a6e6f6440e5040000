...
function renderPromotions(container, template, collection){
    ...
    $.each( collection , function( key, val ) {
        ...
        if(val.promo_image_url_abs.indexOf('missing.png') > 0){
            val.promo_image_url_abs  = "//codecloud.cdn.speedyrails.net/sites/5851bd9a6e6f6440e5040000/image/jpeg/1497457979000/SQ_logo.jpg";
        }
...
function renderStoreDetails(container, template, collection, slug){
    ...
    $.each( item_list , function( key, val ) {
        if ((val.store_front_url).indexOf('missing.png') > -1){
            val.alt_store_front_url = "//codecloud.cdn.speedyrails.net/sites/5851bd9a6e6f6440e5040000/image/jpeg/1497457979000/SQ_logo.jpg";
        } else {
            val.alt_store_front_url = getImageURL(val.store_front_url); 
        }
    ...
    $(trigger).bind("change", function(e) {
        ...
        $(map).smoothZoom('addLandmark', 
			...
			'<div class="item mark" data-show-at-zoom="0" data-position="' + x_coord + ',' + y_coord + '">\
				...
				<img src="//codecloud.cdn.speedyrails.net/sites/5851bd9a6e6f6440e5040000/image/png/1497039299000/map_marker.png" width="45px" height="59px" alt="marker" />\
				</div>\
			</div>'
			]
		);
